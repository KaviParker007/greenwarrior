...
import 'package:greenwarrior/pages/vehicles/add_vehicles.dart';
import 'package:greenwarrior/pages/vehicles/vehicle_view.dart';
...
class _VehiclesListBuilderState extends State<VehiclesListBuilder>
  ...
  Widget _statusBadge(Map vehicle) {
    return Container(
      padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 5),
      decoration: BoxDecoration(
        color: _statusColor(vehicle).withOpacity(0.15),
        borderRadius: BorderRadius.circular(20),
      ),
      child: Text(
        vehicle['current_status'].toString().toUpperCase(),
        style: TextStyle(
          fontSize: 11,
  ...
  Color _statusColor(Map vehicle) {
    if (vehicle['current_status'] == 'utilized') {
      return Colors.green;
    } else if (vehicle['current_status'] == 'under-maintenance') {
      return Colors.grey;
    } else if (vehicle['current_status'] == 'idle') {
